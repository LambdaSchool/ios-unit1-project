...
extension Volume {
    ...
    convenience init?(volumeRepresentation: VolumeRepresentation, context: NSManagedObjectContext = CoreDataStack.shared.mainContext) {
        self.init(title: volumeRepresentation.volumeInfo.title, id: volumeRepresentation.id, hasRead: volumeRepresentation.hasRead!, review: volumeRepresentation.review!, imageLink: volumeRepresentation.imageLinks.thumbnail)
    }
}
